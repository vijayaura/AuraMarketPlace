...
// Mock user data with enhanced fields for insurer
const mockUsers = [
  {
    id: "I001",
    name: "Michael Chen",
  ...
  },
  {
    id: "I002",
    name: "Lisa Rodriguez",
    email: "lisa.rodriguez@insurer.com",
  ...
  },
  {
    id: "I004",
    name: "Jennifer Walsh",
    email: "jennifer.walsh@insurer.com",
  ...
  },
  {
    id: "I005",
    name: "Ahmed Hassan",
    email: "ahmed.hassan@insurer.com",
    role: "Junior Analyst",
    isAdmin: false,
    status: "Pending",
    lastLogin: "Never",
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground">Manage insurer portal users and permissions</p>
          </div>
          <Button 
            className="gap-2"
            onClick={() => navigate("/insurer/add-user")}
          >
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Manage your insurer portal users</CardDescription>
          </CardHeader>
          <CardContent>
                    ...
                    <TableRow key={user.id}>
                      ...
                      <TableCell className="text-right">
                        <Button 
                          variant="outline" 
                          size="sm"
                          onClick={() => navigate(`/insurer/edit-user/${user.id}`)}
                        >
                          Edit Details
                        </Button>
                      </TableCell>
