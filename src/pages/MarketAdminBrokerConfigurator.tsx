...
const MarketAdminBrokerConfigurator = () => {
    ...
    showConfirmDialog(
      {
        ...
        description: "Are you sure you want to save these product assignments and commission rates for the selected broker?",
    ...
    showConfirmDialog(
      {
        ...
        description: "Are you sure you want to save the broker configuration changes?",
...
export default MarketAdminBrokerConfigurator;