...
const MarketAdminBrokerPolicyDetails = () => {
  const navigate = useNavigate();
  const { policyId, brokerId } = useParams();
      ...
      <div className="min-h-screen bg-background flex items-center justify-center">
        <Card className="max-w-md w-full">
          <CardContent className="p-6 text-center">
            ...
            <Button onClick={() => navigate(`/market-admin/broker/${brokerId}/details`)}>
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-4">
              <Button
                variant="ghost"
                size="sm"
                onClick={() => navigate(`/market-admin/broker/${brokerId}/details`)}
              >
                <ArrowLeft className="w-4 h-4 mr-2" />
                Back
              </Button>
...
export default MarketAdminBrokerPolicyDetails;